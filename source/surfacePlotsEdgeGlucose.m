%% Get a surface plot of mitochondrial distributions versus lambda-hat and c0-hat
% for ks=100, 75 mitochondria
...
for i = 1:1:nl
    ...
    for j = 1:1:nc0
        ...
        varmetric(i,j) = 6*var_mito(i,j) - 0.5;
        [ i j varmetric(i,j)]
    end
    %save the workspace
    formatOut = 'yyyymmdd';
    ...
    filename = strcat('../results/surflamc0_',date,'_ks100_n75');
    save (filename);
