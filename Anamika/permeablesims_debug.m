function [gluc,Tmito,Smito,Smito_int,normdtg,gluc_init,opt,xpos,lmdh,ftc] = permeablesims_debug(options)
...
while (normdtg > dtcutoff)
    ...
    dtg(2:end-1) = Dh*d2g(2:end-1) - kgh * opt.Km * opt.nmito * Tmito(2:end-1) ;
